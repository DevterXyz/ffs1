...
os.system("clear")
print ("\033[32m                     ╔════════════════════════════════════╗")
print ("\033[35m                     ║\033[34m  ╔═╗╔═╗╦╔═╦ ╦╦═╗╔═╗\033[31m  ╦╔╗ ╦  ╦╔═╗\033[32m   ║")
print ("\033[35m                     ║\033[34m  ╚═╗╠═╣╠╩╗║ ║╠╦╝╠═╣\033[31m  ║╠╩╗║  ║╚═╗\033[32m   ║")
print ("\033[32m                     ║\033[34m  ╚═╝╩ ╩╩ ╩╚═╝╩╚═╩ ╩\033[31m  ╩╚═╝╩═╝╩╚═╝ \033[32m  ║")
print ("\033[32m                     ╚════════════════════════════════════╝")
print ("\033[32m                              ╔══════════════════╗")
print ("\033[32m                              ║ \033[35m  TOOLS BY \033[34mZ𝕏Z  \033[32m ║") 
print ("\033[32m                              ╚══════════════════╝")
print ("\033[32m                      ╔════════════════════════════════════╗")
print ("\033[32m                      ║    \033[37m   SUBSCRIBE MY \033[31mYOUTUBE         \033[32m║")
print ("\033[32m                      ╚════════════════╦╦══════════════════╝")
ip = str(input("                          \033[37mAttack To IP \033[32m║║\033[31m \033[37m"))           
port = int(input("                        \033[37mAttack To Port \033[32m║║\033[31m \033[37m"))
